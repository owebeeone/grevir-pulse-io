...
using Transmitter = ardo::PweTransmitterModule<ardo::OutputPin<Backend, 4>, Bits,
                                               Clock, std::uint32_t, 10, 200, 100>;
using InvalidApp = ardo::Application<Receiver, Transmitter>;
static_assert(sizeof(InvalidApp) > 0);
} // namespace
